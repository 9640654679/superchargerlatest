        ...
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            <Container delay={0.0}>
                <div className="pl-2 pr-1 py-1 rounded-full border border-foreground/10 hover:border-foreground/15 backdrop-blur-lg cursor-pointer flex items-center gap-2.5 select-none w-max mx-auto">
                    ...
                    <span className="inline-flex items-center justify-center gap-2 animate-text-gradient animate-background-shine bg-gradient-to-r from-[#b2a8fd] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-sm text-transparent">
                        AI-powered survey creation, sharing, and instant insights
                    </span>
                </div>
            </Container>
            <BlurText
                word={"Attract, Engage, and Convert Your Audience"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Create marketing funnels that deliver personalized results, build trust and make sales faster than ever before.
                </p>
            </Container>
            <Container delay={0.2}>
            ...
            <Container delay={0.3}>
                <div className="relative mx-auto max-w-7xl rounded-xl lg:rounded-[32px] border border-neutral-200/50 p-2 backdrop-blur-lg bg-neutral-800/50 md:p-4 mt-12">
                    ...
                    <div className="rounded-lg lg:rounded-[24px] border p-2 border-neutral-700 bg-black">
                        <Image
                            ...
                            alt="AI Survey Platform dashboard screenshot"
                            width={1920}
                            height={1080}
