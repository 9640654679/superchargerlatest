            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Flexible pricing for every survey need
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Whether you're an individual, a team, or an enterprise, our plans make it easy to create, publish, and analyze surveys with AI-powered insights and beautiful charts. No hidden fees—just actionable results.
                    </p>
                </div>
            </Container>
        ...
        <div key={index} className="w-full relative flex flex-col saturate-150 rounded-2xl">
            ...
            >
                ...
                <div className="p-3 mt- h-auto flex w-full items-center">
                    ...
                    >
                        <Link href={id === "free" ? "/sign-up" : "/sign-in"}>
                            {id === "free" ? "Get Started Free" : "See AI Insights"}
                        </Link>
                    </Button>
                </div>
            </div>
