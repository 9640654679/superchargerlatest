            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        What our users say about our AI Survey Platform
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Thousands of users trust our platform to create surveys, collect responses, and unlock actionable insights with AI-powered analysis. Here's how we're helping them make smarter decisions, faster.
                    </p>
                </div>
            </Container>
            <Container>
...
const ReviewCard = ({
    ...
    const platformReview = review.replace(/(platform|tool|service|solution)/gi, 'AI survey platform')
        .replace(/(insights|analysis|results)/gi, 'AI-powered insights and analysis');
    return (
        <figure className="relative w-64 cursor-pointer overflow-hidden rounded-xl border border-foreground/5 bg-neutral-50/[.05] hover:bg-foreground/10 p-4 transition-all duration-300 ease-in-out">
            ...
            <blockquote className="mt-2 text-sm">{platformReview}</blockquote>
        </figure>
    );
};
