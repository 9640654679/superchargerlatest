      ...
      {mode === "manual" ? (
        ...
        <div className="rounded-xl border border-border p-4 md:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mb-6">
            ...
            />
            <button 
              className="px-6 py-4 bg-accent text-accent-foreground font-bold rounded-lg shadow-sm hover:shadow transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center w-full sm:w-auto"
